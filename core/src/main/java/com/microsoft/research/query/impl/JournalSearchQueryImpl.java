...
import com.microsoft.research.query.JournalSearchQuery;
...
/**
 * The Class JournalSearchQueryImpl.
 */
public class JournalSearchQueryImpl extends
		BaseAcademicSearchApiQuery<Journal> implements
		JournalSearchQuery {

	/**
	 * Instantiates a new journal search query impl.
	 * 
	 * @param applicationId the application id
	 */
	public JournalSearchQueryImpl(String applicationId) {
		super(applicationId);
	}
	 ...
	 */
	@Override
	protected PagedList<Journal> unmarshallList(JsonObject response) {
		return super.unmarshallList(response, "Journal",
				new TypeToken<List<Journal>>() {
				});
	}
}
