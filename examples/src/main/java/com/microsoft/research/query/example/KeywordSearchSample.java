...
/**
 * The Class KeywordSearchSample.
 */
public class KeywordSearchSample {
	 ...
	 */
	private static void printResponse(PagedList<Keyword> response) {
    ...
    private static void printHelp(Options options) {
        int width = 80;
        String syntax = KeywordSearchSample.class.getName() + " <options>";
